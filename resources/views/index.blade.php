                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                        <div class="hero__caption">
                            <span>RUMAH SAKIT BHAKTI KARTINI</span>
                            ...
                            <a href="#" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.5s">MASUK<i class="ti-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                        <div class="hero__caption">
                            ...
                            <p data-animation="fadeInLeft" data-delay="0.1s">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi uquip ex ea commodo consequat is aute irure.</p>
                            <a href="/masuk" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.5s">MASUK<i class="ti-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img small-img" style="background-image: url(img/gallery/gallery2.png);"></div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
            ...
            <div class="col-lg-6">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img small-img" style="background-image: url(img/gallery/gallery5.png);"></div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img big-img" style="background-image: url(img/gallery/gallery6.png);"></div>
                        </div>
                    </div>
                </div>
            </div>
